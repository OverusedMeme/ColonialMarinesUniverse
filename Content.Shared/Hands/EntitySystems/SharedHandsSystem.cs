...
public abstract partial class SharedHandsSystem
{
    ...
    public bool TrySetHandLocation(Entity<HandsComponent?> ent, string handName, HandLocation handLocation)
    {
        ...
        // Keep the upstream canonical left-to-right ordering when a fork system
        // corrects the location of an existing hand after it was registered.
        ent.Comp.SortedHands = ent.Comp.SortedHands
